...
function getURL() {
    let URL = `https://api.openweathermap.org/data/2.5/weather?q=` + inputLocation.value + `&APPID=6d7b120da19e1522ae301864dd00ae4e`;
    getData(URL);
}
...
function displayData(myData) {
    ...
    if (descriptionEl.innerHTML === 'Broken clouds' || descriptionEl.innerHTML === 'Few clouds' || descriptionEl.innerHTML === 'Scattered clouds') {
